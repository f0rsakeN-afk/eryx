  ...
  const jsonLd = {
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Legal", item: "/legal/policy" },
        { "@type": "ListItem", position: 3, name: "Privacy Policy", item: "/legal/policy" },
      ],
    },
  };
  return (
            ...
            <div className="divide-y divide-border">
              <LegalSection id="overview" title="Overview">
                <p>
                  ...
                  information about you when you use our services. By using our
                ...
                <p>
                  ...
                  please contact us at the details provided at the bottom of
                  this page.
                </p>
              </LegalSection>
              ...
              <LegalSection id="collection" title="Information We Collect">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    — pages visited, features used, time spent, and interactions
                    within the platform
                  </li>
                  <li>
                    <strong className="text-foreground font-medium">
              ...
              <LegalSection id="use" title="How We Use Your Information">
                ...
                <ul>
                  ...
                  <li>
                    Send transactional emails such as confirmations and security
                    alerts
                  </li>
                  <li>
                ...
                <p>
                  ...
                  will not use your data for purposes beyond those described
                  here without your explicit consent.
                </p>
              </LegalSection>
              ...
              <LegalSection id="retention" title="Data Retention">
                <p>
                  ...
                  account is active or as needed to provide the service. We also
              ...
              <LegalSection id="security" title="Security">
                <p>
                  ...
                  alteration, disclosure, or destruction — including encryption
              ...
              <LegalSection id="changes" title="Changes to This Policy">
                <p>
                  ...
                  this page and, where required, notify you by email or through
                  a prominent notice in the service.
                </p>
                <p>
